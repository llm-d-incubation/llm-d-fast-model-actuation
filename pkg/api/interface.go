...
// BoundLabelName is the name of a label that the dual-pods controller
// maintains on the server-running Pod.
...
// (it does not rely on this label for anything).
const BoundLabelName string = "dual-pods.llm-d.ai/bound"
