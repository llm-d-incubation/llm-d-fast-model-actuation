...
type ServingV1alpha1Interface interface {
	...
	InferenceServerSetsGetter
}

// ServingV1alpha1Client is used to interact with features provided by the serving.llm-d.ai group.
type ServingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServingV1alpha1Client) InferenceServerSets(namespace string) InferenceServerSetInterface {
	return newInferenceServerSets(c, namespace)
}
